...
const mapDefinitions = <String, MapDefinition>{
  ...
  'ruins': MapDefinition(
    ...
    enemies: [
      ...
      SceneEnemyDefinition(
        id: 'bramble_hound_east',
        enemyId: 'bramble_hound',
        label: '東路刺藤獵犬',
        x: 860,
        y: 210,
        canRespawn: true,
      ...
      SceneEnemyDefinition(
        id: 'abyss_watcher_depth',
        enemyId: 'abyss_watcher',
        label: '深處監視者',
        x: 640,
        y: 560,
        canRespawn: true,
      ...
      SceneEnemyDefinition(
        id: 'clockwork_knight_fork',
        enemyId: 'clockwork_knight',
        label: '發條騎士',
        x: 866,
        y: 542,
        canRespawn: true,
      ...
      SceneEnemyDefinition(
        id: 'mist_assassin_elite_sanctum',
        enemyId: 'mist_assassin_elite',
        label: '菁英暗殺者',
        x: 548,
        y: 378,
        canRespawn: true,
      ...
      SceneEnemyDefinition(
        id: 'hex_stalker_elite_sanctum',
        enemyId: 'hex_stalker_elite',
        label: '深淵追獵者',
        x: 305,
        y: 86,
        canRespawn: true,
      ...
      SceneEnemyDefinition(
        id: 'abyss_watcher_lord_peak',
        enemyId: 'abyss_watcher_lord',
        label: '監視者領主',
        x: 906,
        y: 110,
        canRespawn: true,
